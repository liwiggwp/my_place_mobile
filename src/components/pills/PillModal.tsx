  ...
  return (
    ...
    >
      <div
        ...
        className="w-full max-w-md bg-white rounded-t-3xl sm:rounded-3xl p-5 sm:p-6 shadow-2xl border border-purple-100 max-h-[92vh] flex flex-col overflow-hidden cursor-default"
      >
        {/* Header */}
